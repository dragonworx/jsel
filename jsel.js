...
// XPathResult ///////////////////////////////////////////////////////////////
	...
	function Document (node) {
		this._adapters = {};
		this._map = {};
		each(defaultAdapters, function (value, key) {
			this._adapters[key] = value;
		}, this);
		this.init(node);
	}
	...
	Document.prototype = {
		...
		adapters: function (adapters) {
			if (typeof adapters === "object") {
				each(adapters, function (value, key) {
					this._adapters[key] = value;
				}, this);
			}
			return this;
	...
	Node.prototype = {
		...
		adapter: function (propertyName) {
			if (typeof this.cache.ownerDocument._adapters[propertyName] === "function") {
				return this.cache.ownerDocument._adapters[propertyName].call(this, this.node);
			} else if (typeof this.cache.ownerDocument._adapters[propertyName] === "string") {
				return this.node[this.cache.ownerDocument._adapters[propertyName]];
			} else {
				return null;
			}
		},
